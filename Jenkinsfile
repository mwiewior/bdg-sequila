 ...
 try {
          ...
          stage('Readthedocs') {
           ...
           stage('Performance testing') {
                ...
                sh 'ssh cdh00 bash -c "spark-shell --master=local[4] --driver-memory=8g -i /tmp/bdg_perf_sequila.scala --packages org.postgresql:postgresql:42.1.1 --conf spark.biodatageeks.perf.testId=$BRANCH_NAME --jars /tmp/bdg-sequila-assembly-*.jar -v"'
           }
