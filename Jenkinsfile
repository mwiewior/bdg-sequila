 ...
 try {
          ...
          stage('Readthedocs') {
           ...
           stage('Performance testing') {
                ...
                sh "ssh cdh00 '. ~/.profile;spark-shell --master=yarn-client --executor-memory=4g --num-executors=40 --driver-memory=8g -i /tmp/bdg_perf_sequila.scala --packages org.postgresql:postgresql:42.1.1 --conf spark.biodatageeks.perf.testId=$BRANCH_NAME --jars /tmp/bdg-sequila-assembly-*.jar -v'"           }
