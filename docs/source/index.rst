...
0.5.4 (2019-04-13)
 ...
 - support for `disq <https://github.com/disq-bio/disq>`_ for reading BAM and CRAM files
 ...
 - support for `long reads <usecases/usecases.html#nanopore-long-reads-analyses>`_ (e.g. Nanopore) using disq library
